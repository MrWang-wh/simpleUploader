...
public class Contants {
    ...
    public static final String targetfolder = "D:/ideaworkspace/storage_server/storage/"; // 转码后视频保存的目录
    public static final String imageRealPath = "D:/ideaworkspace/storage_server/storage/"; // 截图的存放目录
}
